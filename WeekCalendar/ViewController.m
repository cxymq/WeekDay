...
- (NSArray *)getDatas2 {
    NSDictionary *dic = @{ @"week" : @[@"20天干", @"地支"], @"time" : @"20" };
    NSDictionary *dic2 = @{ @"week" : @[@"21甲", @"乙", @"丙", @"丁", @"戊", @"己", @"庚", @"辛", @"壬", @"癸"], @"time" : @"21" };
    NSDictionary *dic3 = @{ @"week" : @[@"22子", @"丑", @"寅", @"卯", @"辰", @"巳", @"午", @"未", @"申", @"酉", @"戌", @"亥"], @"time" : @"22" };
    NSDictionary *dic4 = @{ @"week" : @[@"23金", @"木", @"水", @"火", @"土"], @"time" : @"23" };
    NSDictionary *dic5 = @{ @"week" : @[@"24子鼠", @"丑牛", @"寅虎", @"卯兔", @"辰龙", @"巳蛇", @"午马", @"未羊", @"申猴", @"酉鸡", @"戌狗", @"亥猪"], @"time" : @"24" };
    NSDictionary *dic6 = @{ @"week" : @[@"25立春", @"雨水", @"惊蛰", @"春分", @"清明", @"谷雨", @"立夏", @"小满", @"芒种", @"夏至", @"小暑", @"大暑"], @"time" : @"25" };
    NSDictionary *dic7 = @{ @"week" : @[@"26立秋", @"处暑", @"白露", @"秋分", @"寒露", @"霜降", @"立冬", @"小雪", @"大雪", @"冬至", @"小寒", @"大寒"], @"time" : @"26" };
    NSDictionary *dic8 = @{ @"week" : @[@"27春季", @"夏季", @"秋季", @"冬季"], @"time" : @"27" };
    NSDictionary *dic9 = @{ @"week" : @[@"28春节（农历正月初一）", @"元宵节（农历正月十五）", @"龙抬头（农历二月初二）", @"社日节（农历二月初二）", @"寒食节（农历冬至后的105天）", @"清明节（公历4月5日前后）", @"端午节（农历五月初五）", @"七夕节（农历七月初七）", @"中元节（农历七月十五）", @"中秋节（农历八月十五）", @"重阳节（农历九月初九）", @"下元节（农历十月十五）", @"冬至节（公历12月21~23日）", @"除夕（年尾最后一天）"], @"time" : @"28" };
    NSDictionary *dic10 = @{ @"week" : @[@"29冀", @"兖", @"青", @"徐", @"扬", @"荆", @"豫", @"益", @"雍"], @"time" : @"29" };
    NSDictionary *dic11 = @{ @"week" : @[@"30伏羲", @"祝融", @"神农", @"黄帝", @"少昊", @"颛顼", @"帝喾", @"尧"], @"time" : @"30" };
    NSArray *datas = @[dic, dic2, dic3, dic4, dic5, dic6, dic7
                       , dic8, dic9
                       , dic10, dic11
    ];
